        ...
        <div className="space-y-8">
            ...
            <div className="p-4 border border-border-light dark:border-border-dark rounded-lg bg-background-light dark:bg-background-dark/30">
                ...
                <p className="text-xs text-text-secondary-light dark:text-text-secondary-dark mt-1">
                    Guarde todos sus registros y archivos físicos en un único archivo .zip. Ideal para mantener sus datos seguros o moverlos a otro dispositivo.
                </p>
                <button 
                ...
                >
                    ...
                    {isExporting ? 'Exportando...' : 'Crear y Descargar Respaldo'}
                </button>
            </div>
